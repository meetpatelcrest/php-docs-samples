...
list($_, $projectId, $locationId, $templateId, $pdfContentFilename) = $argv;
...
// $pdfContentFilename = 'YOUR_PDF_FILE_NAME'; // e.g. ''path/to/file.pdf';
...
// Read the PDF file content and encode it in base64
$pdfContent = file_get_contents($pdfContentFilename);
